...
function subscribe(topic) {
	...
	document.getElementById("messages").innerHTML = '<span> 모니터링: ' + topic + '</span><br/>';
...
function unsubscribe(topic) {
	...
	// 신청 취소를 <div> 영역에 출력
	document.getElementById("messages").innerHTML = '<span>모니터링취소: ' + topic + '</span><br/>';
